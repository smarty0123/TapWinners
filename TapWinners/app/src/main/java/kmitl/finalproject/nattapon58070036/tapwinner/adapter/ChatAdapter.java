package kmitl.finalproject.nattapon58070036.tapwinner.adapter;
...
import kmitl.finalproject.nattapon58070036.tapwinner.adapter.holder.ChatHolder;
...
public class ChatAdapter extends RecyclerView.Adapter<ChatHolder>{
    ...
    public void onBindViewHolder(ChatHolder holder, int position) {
        Glide.with(getApplicationContext()).load(data.get(position).getImgUri()).into(holder.chatProfileImage);
